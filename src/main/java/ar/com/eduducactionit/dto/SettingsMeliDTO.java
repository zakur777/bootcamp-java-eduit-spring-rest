...
public class SettingsMeliDTO {
    ...
    private String maximumPriceCurrency;
    @JsonProperty("minimum_price")
    private Integer minimumPrice;
    @JsonProperty("minimum_price_currency")
    private String minimumPriceCurrency;
    ...
    private List<String> buyerProtectionPrograms = null;
    @JsonProperty("status")
    ...
    @JsonProperty("minimum_price_currency")
    public String getMinimumPriceCurrency() {
        return minimumPriceCurrency;
    }

    @JsonProperty("minimum_price_currency")
    public void setMinimumPriceCurrency(String minimumPriceCurrency) {
        this.minimumPriceCurrency = minimumPriceCurrency;
    }
    ...
    @JsonProperty("buyer_protection_programs")
    public List<String> getBuyerProtectionPrograms() {
        return buyerProtectionPrograms;
    }

    @JsonProperty("buyer_protection_programs")
    public void setBuyerProtectionPrograms(List<String> buyerProtectionPrograms) {
